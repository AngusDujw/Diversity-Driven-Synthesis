...
parser.add_argument("--check-ckpt", default='', type=str)
parser.add_argument("--networks", default='resnet18', type=str, help="select from resnet18, resnet34, resnet50, \
                    mobilenetV2, efficientnet, shufflenet")
